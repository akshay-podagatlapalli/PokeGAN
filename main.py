...
from pokeGAN import Discriminator, Generator, initialize_weights
from pokemondatasetloader import PokeData
...
dataset = PokeData(csv_file=csv_file, root_dir=root_dir, transform=transforms) 
